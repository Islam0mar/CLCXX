...
#define CLCXX_VERSION_MAJOR 0
#define CLCXX_VERSION_MINOR 1
...
#define CLCXX_VERSION_STRING __CLCXX_STR(CLCXX_VERSION_MAJOR) "." __CLCXX_STR(CLCXX_VERSION_MINOR) "." __CLCXX_STR(CLCXX_VERSION_PATCH)
